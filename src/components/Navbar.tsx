            ...
            <div className="max-w-5xl mx-auto px-4">
                <div className="flex justify-between items-center h-16">
                    <Link to="/" className="font-mono text-xl font-bold text-white">
                        risen<span className="text-blue-300">app</span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center">
                        {user ? (
                            <div className="flex items-center space-x-4">
                                ...
                                <button
                                    onClick={signOut}
                                    className="bg-red-700 px-3 py-1 rounded hover:text-black transition duration-300"
                                >
                                    Sign Out
                                </button>
                            </div>
                            ...
                            <button
                                ...
                                className="bg-blue-500 px-3 py-1 rounded hover:bg-blue-700 transition duration-300"
                            >
                                Sign in with Google
                            </button>
                        )}
